...
<body>
	<div id="container">
		<div class="logo">
			<a href="${ctx}" target="_blank" title="痛快在线教育软件 - 在线教育整体解决方案提供商">
				<img src="${ctx}/static/admin/assets/巨锤logo.png" width="200" alt="痛快在线教育软件 - 在线教育整体解决方案提供商" />
			</a>
		</div>
	</div>
	...
	<div class="b-box">
		<div id="container">
			...
			<div class="login-foot">
				<span>
					Powered By <a target="_blank" href="http://www.greathammer.com/" style="color: #666;">${websitemap.web.company}</a>
				</span>
			</div>
		</div>
	</div>
